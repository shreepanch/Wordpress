 ...
 */
function intuitive_custom_controls( $wp_customize ) {
	// Custom control for Important Links.
	class Intuitive_Important_Links extends WP_Customize_Control {
		...
		public function render_content() {
			...
			$important_links = array(
				'theme_instructions' => array(
					'link'  => esc_url( 'https://catchthemes.com/theme-instructions/intutive/' ),
					'text'  => esc_html__( 'Theme Instructions', 'intuitive' ),
					),
				'support' => array(
					'link'  => esc_url( 'https://catchthemes.com/support/' ),
					'text'  => esc_html__( 'Support', 'intuitive' ),
					),
				'changelog' => array(
					'link'  => esc_url( 'https://catchthemes.com/changelogs/intuitive-theme/' ),
					'text'  => esc_html__( 'Changelog', 'intuitive' ),
					),
				'facebook' => array(
					'link'  => esc_url( 'https://www.facebook.com/catchthemes/' ),
					'text'  => esc_html__( 'Facebook', 'intuitive' ),
					),
				'twitter' => array(
					'link'  => esc_url( 'https://twitter.com/catchthemes/' ),
					'text'  => esc_html__( 'Twitter', 'intuitive' ),
					),
				'gplus' => array(
					'link'  => esc_url( 'https://plus.google.com/+Catchthemes/' ),
					'text'  => esc_html__( 'Google+', 'intuitive' ),
					),
				'pinterest' => array(
					'link'  => esc_url( 'http://www.pinterest.com/catchthemes/' ),
					'text'  => esc_html__( 'Pinterest', 'intuitive' ),
					),
			);
	...
	class Intuitive_Multi_Cat extends WP_Customize_Control {
		...
		public function render_content() {
			$dropdown = wp_dropdown_categories(
				array(
					...
					'hide_if_empty'    => false,
					'show_option_all'  => esc_html__( 'All Categories', 'intuitive' ),
				)
			);
			...
			echo '<p class="description">' . esc_html__( 'Hold down the Ctrl (windows) / Command (Mac) button to select multiple options.', 'intuitive' ) . '</p>';
		}
	}

	// Custom control for any note, use label as output description.
	class Intuitive_Note_Control extends WP_Customize_Control {
	...
	class Intuitive_Toggle_Control extends WP_Customize_Control {
		public $type = 'light';
...
add_action( 'customize_register', 'intuitive_custom_controls', 1 );
